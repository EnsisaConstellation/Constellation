...
public class Room implements Serializable {
	...
	public Room(String name, String user){
		...
		System.out.println("cr�ation du salon " + name + " par l'utilisateur " + user);
	}
	...
	public void receive(Message message, Map<String, User> users) throws InterruptedException{//le saloon recoit une message d'un utilisateur
		//il le met dans la liste des messages et l'envoie � chaque utilisateur inscrit (via send)
	...
	public void sendMsg(String user, int index, Map<String, User> users) throws InterruptedException{//ajoute un message � un utilisateur
		//if(!messages.isEmpty())
